...
QT_MOC_LITERAL(3, 26, 9), // "saveframe"
QT_MOC_LITERAL(4, 36, 10) // "readPacket"

    },
    "VideoPlayer\0readOneframe\0\0saveframe\0"
    "readPacket"
};
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->saveframe((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 2: _t->readPacket(); break;
        default: ;
        }
        ...
        {
            typedef void (VideoPlayer::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoPlayer::saveframe)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void VideoPlayer::saveframe(QImage _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
